package com.blez.myapplication.feature_note.presentation.notes
...
import com.blez.myapplication.feature_note.domain.model.NotesState
...
class NoteViewModel @Inject constructor(private val noteUseCases: NoteUseCases) : ViewModel(){
        ...
        when(event){
            ...
            viewModelScope.launch {
                if (recentlyDeletedNote != null){
                    noteUseCases.createNote(recentlyDeletedNote!!)
            ...
            NotesEvent.ToggleOrderSection -> {
                _state.value = state.value.copy(isOrderSectionVisible = !_state.value.isOrderSectionVisible)
    ...
    private fun getNotes(noteOrder : NoteOrder){
        ...
        getNotesJob = noteUseCases.getNotes(noteOrder)
            .onEach {
                _state.value = state.value.copy(notes = it,noteOrder)
            }
